...
- **Harga**: Tag ~Rp500, reader (misal, Zebra FX9600) ~Rp30 juta.
...
- **Tambah Barang Baru**:
  - Kamera AI gak kenal barang, Budi ambil foto.
  ...
  - Dashboard konfirmasi: “Model_v2 aktif.”
...
- **Keadaan**:
  ...
  - Metal Detector: Deteksi logam, alarm bunyi.
- **Proses**:
  - Raspberry Pi kirim SMS ke Anita: “Logam terdeteksi!”
...
- **Hasil**: Dashboard catat: “ITEM123 diambil, 12:15 PM.”

### 3.4. Kasus 4: Kerusakan Peralatan (Kamera AI Mati)
- **Konteks**: Kamera AI di Surabaya 1 mati karena listrik down, 12:20 PM.
- **Keadaan**:
  - Kamera gak bisa scan barang baru (ITEM789, gelang emas).
  - Sistem kirim alert: “Kamera offline, gunakan prosedur manual.”
- **Proses**:
  - Budi input data manual di dashboard: `item_id: ITEM789, jenis: Gelang emas, berat: 15g`.
  - Pasang tag AM dan RFID, sensor berat verifikasi: 15g.
  - Data disimpen di RDS/server lokal, tapi gak ada verifikasi AI.
  - Teknisi dipanggil, ganti kabel listrik, kamera nyala lagi (30 menit).
- **Hasil**: Dashboard catat: “ITEM789 disimpan tanpa AI, teknisi selesai 12:50 PM.”

### 3.5. Kasus 5: Kesalahan Input Data oleh Karyawan
- **Konteks**: Budi salah input berat kalung (ITEM234) jadi 50g (harusnya 5g), 12:25 PM.
- **Keadaan**:
  - Sensor berat di A-14 deteksi 5g, beda sama data input (50g).
  - Sistem kasih alert: “Data berat gak cocok, cek ulang!”
- **Proses**:
  - Anita buka dashboard, lihat peringatan.
  - Budi koreksi data di dashboard: `UPDATE items SET berat = 5 WHERE item_id = 'ITEM234';`.
